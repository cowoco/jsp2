  ...
  <section>
    ...
    <table>
      		...
      		$("#likeStatus").click(function(){
      			...
      			$.ajax({
      				...
      				success:function(data){
      					...
      					htmlData = '';
      	      			htmlData += '좋아요 <i class="fa-solid fa-thumbs-up"></i><span class="likeNo"> '+num+' </span>';
      			...
      			$.ajax({
      				...
      				success:function(data){
      					...
      					alert("총 좋아요 개수 : "+data.all_like_count);
      					htmlData = '';
      	      			htmlData += '좋아요 <i class="fa-regular fa-thumbs-up"></i><span class="likeNo"> '+num+' </span>';
      	      			$("#likeStatus").html(htmlData);
      				},
      				error:function(){
      					alert("실패");
      ...
      <tr>
        ...
        <i class="fa-solid fa-thumbs-up"></i><span class="likeNo"> ${all_like_count}</span>
        </c:if>
        <c:if test="${my_like_count!=1 }">
        <i class="fa-regular fa-thumbs-up"></i><span class="likeNo"> ${all_like_count}</span>
        </c:if>
        </td>
      </tr>
      <tr>
